...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/adf5b29f07.js" crossorigin="anonymous"></script>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="saldo" value="${cliente.saldo}" required >
                                    </div>
                                </div>
                            </div>
                        </div>
