...
import service.ConsultorioMedicoService;
            ...
            protected void doAccept() {
                ...
                try {
                    if (nombre_consultorio_txt.length() > 0 && medico_dni_txt > 0) {
                        List<Object> consultorio_consultado = ConsultorioMedicoService.consultarConsultoriosMedicos(nombre_consultorio_txt, medico_dni_txt);
                        ...
                        List<Object> consultorio_consultado = ConsultorioMedicoService.consultarConsultorioMedicoFecha(medico_dni_txt, fecha_reserva_txt);
