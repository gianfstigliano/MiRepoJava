...
public class ModificarTurno extends CrearModificarTurno {

    public ModificarTurno(PanelManager m) {
        super(m);
        super.consultorio.disable();
    }
    ...
    protected void ejecutar() {
        ...
        if (consultorio.length() > 0 && dni_medico > 0 && ano > 1900 && ano < 2021 && mes > 0 && mes < 13
            ...
            try {
                String respuesta = TurnoService.modificarTurno(dni_medico, dni_paciente, fecha_turno, hora_turno);
                int respuesta_joption = JOptionPane.showConfirmDialog(this, respuesta,
                        "Modificando Turno", JOptionPane.OK_CANCEL_OPTION);
                if (respuesta_joption == JOptionPane.OK_OPTION) {
                    m.mostrarPantallaTurno();
                }
            } catch (ServicioException e) {
                JOptionPane.showMessageDialog(this, "Hubo un problema al modificar el turno",
