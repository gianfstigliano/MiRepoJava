...
public class TurnoService {
    ...
    public static String crearTurno(int medico_dni, int paciente_dni, String fecha_turno, String hora_turno, String consultorio) throws ServicioException {
        ...
        List<Object> consultorio_encontrado = ConsultorioService.consultarConsultorio(consultorio);
        ...
        List<Object> consultorio_medico = ConsultorioMedicoService.consultarConsultorioMedicoFecha(medico_dni, fecha_turno);
        ...
        try {
            ...
            List<Object> medico = MedicoService.consultarMedico(dni_medico);
            ...
            if (medico.size() > 0) {
                ...
                String obra_social_paciente = (String) ((List<Object>) PacienteService.consultarPaciente(dni_paciente).get(0)).get(4);
